...
from tfndlstm import lstm2d
from tfspecs import specs_lib
...
DilCx = Fun(tf.nn.atrous_conv2d)
DilCs = Fun(tf.nn.atrous_conv2d, activation_fn=tf.nn.sigmoid)
DilCt = Fun(tf.nn.atrous_conv2d, activation_fn=tf.nn.tanh)
DilCr = Fun(tf.nn.atrous_conv2d, activation_fn=tf.nn.relu)
DilCm = Fun(tf.nn.atrous_conv2d, activation_fn=tf.nn.softmax)
DilCl = Fun(tf.nn.atrous_conv2d, activation_fn=None)
